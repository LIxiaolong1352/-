...
abstract_text = f'''篮球运动是大学生最喜爱的体育运动项目之一，但膝关节损伤问题日益突出，严重影响大学生的身心健康和运动参与。膝关节作为人体最大、最复杂的关节，承担着支撑身体重量和完成跑跳动作的重要功能。曹炜从解剖学角度指出，膝关节在半屈位（130°-150°）时稳定性最差，而篮球运动中的大部分技术动作正是在此角度下完成，这使得膝关节成为最容易受伤的部位[1]。张涛的生物力学研究也证实，屈膝130°-150°时伸膝力量最大但稳定性最差，半屈位时韧带松弛，易发生韧带和半月板损伤[2]。

本研究以江汉大学大学生篮球运动参与者为研究对象，采用问卷调查法、文献资料法和数理统计法，对大学生篮球运动膝关节损伤现状及预防策略进行系统研究。参考张海军对辽宁省青少年体校运动员的调查方法，设计《大学生篮球运动膝关节损伤调查问卷》[3]。问卷内容包括基本信息、运动情况、损伤情况、影响因素四个部分。共发放问卷{total}份，回收有效问卷{total}份，有效回收率100%。调查对象包括体育学院篮球专项学生和普通篮球爱好者，涵盖不同性别、不同运动年限的大学生群体。
...
# 保存
doc.save(r'C:\Users\Administrator\Desktop\毕业论文_刘小龙_扩充版.docx')
print("已保存")
